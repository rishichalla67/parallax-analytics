...
export default function UpdatePosition({selectedPosition, setShowModal, setSuccessMessage}){
        ...
        await updatePosition(
          ...
          Position(
            ...
            updateTypeRef.current.value === ""
              ...
              : updateTypeRef.current.value,
              updateAvgCostRef.current.value === "" ? selectedPosition.avgCost : parseFloat(updateAvgCostRef.current.value).toFixed(2)),
