    ...
    return (
        <div className="bg-gray-800 text-white p-2">
            <div className="flex flex-col sm:flex-row sm:gap-4 text-sm">
                <div className="text-xl font-medium leading-6">PnL</div>
                <div className="flex flex-wrap sm:gap-4">
                <div className={`text-center sm:text-left p-1 `}>
                    1D: 
                    <a className={`pl-2 ${pnl1D >= 0 ? "text-green-500" : "text-red-500"}`}>
                        {pnl1D}%
                    </a>
                ...
                <div className={`text-center sm:text-left p-1 `}>
                    1W: 
                    <a className={`pl-2 ${pnl1W >= 0 ? "text-green-500" : "text-red-500"}`}>
                        {pnl1W}%
                    </a>
                ...
                <div className={`text-center sm:text-left p-1 `}>
                    1M: 
                    <a className={`pl-2 ${pnl1M >= 0 ? "text-green-500" : "text-red-500"}`}>
                        {pnl1M}%
                    </a>
                ...
                <div className={`text-center sm:text-left p-1 `}>
                    1Y: 
                    <a className={`pl-2 ${pnl1Y >= 0 ? "text-green-500" : "text-red-500"}`}>
                        {pnl1Y}%
                    </a>
